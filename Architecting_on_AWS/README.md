...
- [Amazon S3 Transfer Acceleration
  속도 측정](http://s3-accelerate-speedtest.s3-accelerate.amazonaws.com/en/accelerate-speed-comparsion.html)
...
- [EC2 배치 그룹](https://docs.aws.amazon.com/ko_kr/AWSEC2/latest/UserGuide/placement-groups.html)
...
- [AWS 관리 콘솔에서 교차 계정 접근(Cross-Accounts Access) 활용하기](https://aws.amazon.com/ko/blogs/korea/cross-account-access-in-the-aws-console/)
